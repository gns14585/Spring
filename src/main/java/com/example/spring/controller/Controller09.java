...
import com.example.spring.domain.MyDto7_7;
...
public class Controller09 {
    ...
    public void method2(Model model) {
        String[] myArr2 = {"seoul, jeju"};
        model.addAttribute("myName", myArr2);

        String[] myArr3 = {"gns14585@naver.com", "dlwjdgns920@naver.com"};
        model.addAttribute("yourEmail", myArr3);

        String[] myArr4 = {"seoul"};
        model.addAttribute("herAddress", myArr4);
    }
    ...
    public void method3(Model model) {
        ...
        model.addAttribute("list1", List.of("Cat", "Dog"));
        model.addAttribute("mapList1", List.of("Work", "Run"));
        model.addAttribute("cities", List.of("abc", "def", "ghi", "아무글씨"));
    }
    ...
    public void method4(Model model) {
        ...
        var map2 = Map.of("seoul", "서울", "busan", "부산");
        var color123 = Map.of("red", "빨강", "blue", "파랑", "black", "검정");

        model.addAttribute("cityMap", map2);
        model.addAttribute("color", color123);
    ...
    public void method6(Model model) {
        ...
        model.addAttribute("attr3", new MyDto7_7());
    }
    ...
    public void method8(Model model) {
        model.addAttribute("student", new MyDto9());
    }
}
